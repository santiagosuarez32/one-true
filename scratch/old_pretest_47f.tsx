...
const benefits = [
  "Mejora la calidad de la información obtenida antes del examen.",
  "Reduce errores por preguntas ambiguas o mal contextualizadas.",
  "Aumenta la consistencia técnica entre entrevista, test y análisis.",
  "Fortalece la toma de decisiones en contextos forenses, corporativos y de seguridad.",
];
        ...
        <div className="w-full max-w-6xl lg:max-w-7xl xl:max-w-[1350px] mx-auto px-8 md:px-12 lg:px-16">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-14 items-center">
            <div>
              <div className="flex items-center gap-3 mb-5">
                <div className="w-12 h-[2px] bg-[#700FA3]" />
                <span className="text-sm font-semibold text-[#700FA3]" style={{ fontFamily: "var(--font-montserrat), sans-serif", letterSpacing: "1px" }}>
                  Aplicación profesional
                </span>
              </div>
              <h2 className="text-3xl md:text-[38px] font-bold text-[#48255A] leading-tight mb-5" style={{ fontFamily: "var(--font-montserrat), sans-serif" }}>
                Diseñado para poligrafistas que necesitan mayor precisión en campo
              </h2>
              <p className="text-[#525252] text-[15px] leading-[26px] font-light" style={{ fontFamily: "var(--font-montserrat), sans-serif" }}>
                El módulo está orientado a profesionales que ya conocen los fundamentos de la poligrafía y buscan perfeccionar la etapa más sensible del proceso: la conversación donde se aclaran hechos, se establecen límites y se preparan las preguntas que guiarán la evaluación.
              </p>
            </div>

            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              {benefits.map((benefit) => (
                <div key={benefit} className="bg-white border border-neutral-200/80 rounded p-5 shadow-sm">
                  <div className="w-8 h-8 rounded bg-[#FFC107] text-[#411A56] font-bold flex items-center justify-center mb-4">
                    <svg className="w-5 h-5" fill="none" stroke="currentColor" strokeWidth="2.5" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" d="M4.5 12.75l6 6 9-13.5" />
                    </svg>
                  </div>
                  <p className="text-sm text-[#525252] leading-relaxed font-medium" style={{ fontFamily: "var(--font-montserrat), sans-serif" }}>
                    {benefit}
                  </p>
                </div>
              ))}
        ...
        <div className="max-w-6xl lg:max-w-7xl xl:max-w-[1200px] mx-auto px-6 md:px-12 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-10 items-center">
            <div className="lg:col-span-6 flex flex-col text-left">
              ...
              <h2 className="text-[32px] leading-10 font-bold text-white mt-2.5 mb-5" style={{ fontFamily: "var(--font-montserrat), sans-serif" }}>
                Contactos
              </h2>
              ...
              <div className="flex flex-col gap-5">
                <div className="flex items-start gap-5">
                  ...
                  <div className="flex flex-col">
                    ...
                    <a href="tel:0981296179" className="text-white/85 text-base font-light hover:text-[#FFC107] transition-colors">
                      098 129 6179
                    </a>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-5">
                  ...
                  <div className="flex flex-col">
                    <h3 className="text-lg font-bold text-white mb-1">Correo</h3>
                    <a href="mailto:info@somosonetrue.com" className="text-white/85 text-base font-light hover:text-[#FFC107] transition-colors">
              ...
              <div className="bg-white rounded p-6 sm:p-8 shadow-[0_25px_60px_rgba(0,0,0,0.35)] border border-neutral-100 relative overflow-hidden transition-all duration-500">
                {!formSubmitted ? (
                  ...
                  >
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5">
                      <div className="flex flex-col gap-1">
                        ...
                        <input type="text" placeholder="Tu nombre" className="px-4 py-2.5 rounded border-0 bg-neutral-50 text-neutral-800 placeholder-neutral-400 focus:outline-none focus:ring-2 focus:ring-[#700FA3]/20 focus:bg-white focus:shadow-md transition-all w-full text-sm font-medium" required />
                      </div>
                      <div className="flex flex-col gap-1">
                        <label className="text-xs font-semibold text-neutral-600">Apellido *</label>
                        <input type="text" placeholder="Tu apellido" className="px-4 py-2.5 rounded border-0 bg-neutral-50 text-neutral-800 placeholder-neutral-400 focus:outline-none focus:ring-2 focus:ring-[#700FA3]/20 focus:bg-white focus:shadow-md transition-all w-full text-sm font-medium" required />
                      </div>
                    </div>

                    <div className="flex flex-col gap-1">
                      <label className="text-xs font-semibold text-neutral-600">Correo electrónico *</label>
                      <input type="email" placeholder="correo@empresa.com" className="px-4 py-2.5 rounded border-0 bg-neutral-50 text-neutral-800 placeholder-neutral-400 focus:outline-none focus:ring-2 focus:ring-[#700FA3]/20 focus:bg-white focus:shadow-md transition-all w-full text-sm font-medium" required />
                    </div>

                    <div className="flex flex-col gap-1">
                      <label className="text-xs font-semibold text-neutral-600">Número de teléfono *</label>
                      <div className="relative flex items-center border-0 rounded bg-neutral-50 focus-within:ring-2 focus-within:ring-[#700FA3]/20 focus-within:bg-white focus-within:shadow-md transition-all overflow-hidden">
                        ...
                        <input type="tel" placeholder="098 129 6179" className="flex-1 px-4 py-2.5 bg-transparent border-none text-neutral-800 placeholder-neutral-400 focus:outline-none focus:ring-0 text-sm font-medium" required />
                      </div>
                    </div>

                    <div className="flex flex-col gap-1">
                      <label className="text-xs font-semibold text-neutral-600">Ciudad *</label>
                      <input type="text" placeholder="Tu ciudad" className="px-4 py-2.5 rounded border-0 bg-neutral-50 text-neutral-800 placeholder-neutral-400 focus:outline-none focus:ring-2 focus:ring-[#700FA3]/20 focus:bg-white focus:shadow-md transition-all w-full text-sm font-medium" required />
                    </div>

                    <div className="flex flex-col gap-1">
                      <label className="text-xs font-semibold text-neutral-600">Mensaje *</label>
                      <textarea placeholder="Quiero información sobre el módulo Entrevista Pretest..." rows={2} className="px-4 py-2.5 rounded border-0 bg-neutral-50 text-neutral-800 placeholder-neutral-400 focus:outline-none focus:ring-2 focus:ring-[#700FA3]/20 focus:bg-white focus:shadow-md transition-all w-full text-sm font-medium resize-none" required />
                    </div>
                    ...
                    <div className="flex flex-col gap-4 mt-2">
                      ...
                      <div className="flex items-center gap-3">
                        <input type="checkbox" id="aceptar-pretest" className="w-4 h-4 rounded border-neutral-300 text-[#700FA3] focus:ring-[#700FA3] cursor-pointer" required />
                        <label htmlFor="aceptar-pretest" className="text-xs font-bold text-neutral-700 cursor-pointer select-none">
                          Aceptar
                        </label>
                      </div>
                    </div>

                    <button type="submit" className="mt-2 px-8 py-3.5 bg-[#700FA3] hover:bg-[#5C0B87] text-white font-bold rounded transition-all duration-300 w-full shadow-lg shadow-[#700FA3]/25 hover:scale-[1.01] active:scale-[0.99] text-base">
                      Cotizar ahora
                    </button>
                  </form>
                ) : (
                  <div className="flex flex-col items-center text-center py-10">
                    ...
                    <h3 className="text-3xl font-extrabold text-[#48255A] mb-3">
                      ¡Solicitud recibida!
                    </h3>
                    <p className="text-neutral-500 text-sm font-light max-w-sm mb-8 leading-relaxed">
                      Gracias por su interés en Entrevista Pretest. Un asesor de One True se comunicará con usted pronto.
                    </p>
                    <button onClick={() => setFormSubmitted(false)} className="px-6 py-3 border-2 border-[#700FA3] text-[#700FA3] hover:bg-[#700FA3] hover:text-white font-bold rounded transition-all duration-300 text-sm">
