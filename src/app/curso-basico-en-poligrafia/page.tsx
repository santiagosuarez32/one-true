            ...
            {[
              {
                ...
                desc: "Instrucción profunda en el uso de instrumentos de última generación y software especializado.",
                icon: <Monitor size={72} weight="thin" color="#700FA3" className="shrink-0" />
              },
              {
                title: "Metodología Científica",
                desc: "Formación en técnicas de entrevista, fisiología, psicología, análisis de datos, y sistemas de puntuación validados.",
                icon: <Brain size={72} weight="thin" color="#700FA3" className="shrink-0" />
              },
              {
                title: "Práctica Forense",
                desc: "Desarrollo de habilidades reales mediante simulaciones y casos supervisados por instructores senior.",
                icon: <Fingerprint size={72} weight="thin" color="#700FA3" className="shrink-0" />
              },
              {
                title: "Aval Internacional",
                desc: "Certificación reconocida que le permite ejercer bajo los estándares de la APA a nivel mundial.",
      ...
      <section className="bg-white py-24 relative overflow-hidden">
        <div className="w-full max-w-6xl lg:max-w-7xl xl:max-w-[1650px] mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col items-center text-center mb-16">
            ...
            >
              Requisitos y Recursos del Programa
            </h2>
          </div>
            ...
            {[
              {
                ...
                text: "Título universitario o en etapa final de carrera en Psicología, Derecho, Criminología, Sociología o áreas afines de seguridad. Se requiere hoja de vida y récord de conducta intachable.",
                icon: <UserFocus size={72} weight="thin" color="#700FA3" className="shrink-0" />
              },
              {
                title: "Modalidad Híbrida Inteligente",
                text: "Clases teóricas virtuales interactivas en vivo (plataforma interactiva) complementadas con talleres presenciales prácticos intensivos en laboratorios periciales periciales propios en Quito y Guayaquil.",
                icon: <Devices size={72} weight="thin" color="#700FA3" className="shrink-0" />
              },
              {
                title: "Material Forense Incluido",
                text: "Acceso a licencias temporales de software de análisis de gráficos de polígrafo forense digital, manuales académicos impresos y guías periciales bajo directrices APA.",
                icon: <BookOpen size={72} weight="thin" color="#700FA3" className="shrink-0" />
              },
              {
                title: "Certificación e Incorporación",
                text: "Doble certificación oficial: Diploma de la Academia Forense de One True y preparación técnica total que cumple con todos los requisitos para postular como miembro activo a asociaciones globales.",
                      ...
                      <div className="flex flex-col items-center gap-1.5 mt-5 pt-4 border-t border-neutral-100 w-full">
                        ...
                        <div className="elementor-button-wrapper flex justify-center w-auto mt-1">
                          <a 
                            ...
                            href="https://api.whatsapp.com/send?phone=593981296179&text=Hola!%20Deseo%20conocer%20mas%20informacion%20sobre%20el%20Curso%20Basico%20de%20Poligrafia%20400H."
                            target="_blank"
                            rel="noopener noreferrer"
                            style={{ 
                              fontFamily: "var(--font-montserrat), sans-serif", 
