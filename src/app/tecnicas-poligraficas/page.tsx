            ...
            <table className="w-full table-fixed text-left border-collapse bg-white">
              ...
              <tbody className="divide-y divide-[#700FA3]/20">
                ...
                <tr className="bg-[#700FA3]/5">
                  <td className="py-4 px-3 sm:py-5 sm:px-6 font-semibold text-[#48255A] text-sm sm:text-base break-words align-top align-top" style={{ fontFamily: "var(--font-montserrat), sans-serif" }}>¿Qué incluye este curso avanzado?</td>
