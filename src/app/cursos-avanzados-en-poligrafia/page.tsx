              ...
              <div className="flex flex-col gap-5">
                <div className="flex items-start gap-5">
                  ...
                  <div className="flex flex-col">
                    ...
                    <a href="tel:593099371290" style={{ color: "rgba(255, 255, 255, 0.85)", fontSize: "16px", fontWeight: "300", fontFamily: "var(--font-montserrat), sans-serif" }} className="hover:text-[#FFC107] transition-colors">
                      +593 099 371 2790
                    </a>
                  </div>
                </div>
                    ...
                    <div className="flex flex-col items-center gap-1.5 mt-5 pt-4 border-t border-neutral-100 w-full">
                      ...
                      <div className="elementor-button-wrapper flex justify-center w-auto mt-1">
                        <a
                          ...
                          href="https://api.whatsapp.com/send?phone=593099371290&text=Hola!%20Deseo%20conocer%20mas%20informacion%20sobre%20los%20Cursos%20Avanzados%20en%20Poligrafia."
                          target="_blank"
