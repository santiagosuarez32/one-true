...
export default function CalificacionGraficasPage() {
    ...
    <main className="min-h-screen bg-white text-[#525252] selection:bg-[#FFC107] selection:text-[#411A56]">
      ...
      <section className="relative min-h-[80vh] flex items-start md:items-center justify-center overflow-hidden pt-32 pb-24 bg-[#700FA3]">
        ...
        <img
          ...
          alt="Calificación de Gráficas - One True Academia"
          fetchPriority="high"
        ...
        <div className="w-full max-w-6xl lg:max-w-7xl xl:max-w-[1350px] mx-auto px-4 sm:px-8 md:px-12 lg:px-16 z-10 flex justify-start items-center">
          <div className="max-w-5xl text-left">
            ...
            <div className="flex items-center gap-3 mb-6">
              ...
              >
                Transforme trazados fisiológicos en decisiones técnicas basadas en evidencia.
              </span>
            </div>
            ...
            >
              Curso Avanzado: <strong style={{ fontWeight: "800", textDecoration: "underline", textDecorationColor: "#FFC107", textUnderlineOffset: "6px" }}>Calificación de Gráficas y Análisis de Datos</strong>
            </h1>
            ...
            >
              La validez de una examinación poligráfica no reside solo en la ejecución, sino en la precisión del análisis. Este curso especializado le proporcionará el marco metodológico necesario para realizar una calificación objetiva, reduciendo el margen de error y eliminando la subjetividad en la interpretación de los datos.
            </p>
          ...
          <div className="flex flex-col gap-16">
            <div className="flex flex-col gap-12 items-start">
              <div className="w-full max-w-4xl flex flex-col text-left">
                ...
                >
                  Marco metodológico para análisis objetivos
                </h2>
                ...
                >
                  La calificación de gráficas poligráficas se estructura en tres ejes metodológicos que garantizan precisión y objetividad en cada evaluación, eliminando la subjetividad del análisis.
                </p>
              </div>
            </div>
            ...
            <div className="flex flex-col gap-8">
              {focusAreas.map((area) => {
                const isEjesTematicos = area.title === "Ejes Temáticos";
                return (
                  <div key={area.title} className={`flex flex-col ${!isEjesTematicos ? 'lg:flex-row' : ''} items-start gap-8 lg:gap-12 bg-white p-8 lg:p-10 rounded-2xl ${isEjesTematicos ? 'border-l-4 border-l-[#FFC107] border border-neutral-100' : 'border border-neutral-100'} shadow-[0_8px_30px_rgba(0,0,0,0.02)] hover:shadow-[0_15px_35px_rgba(112,15,163,0.04)] transition-all duration-300`}>
                    {!isEjesTematicos && (
                    ...
                    <div className="flex-1">
                      ...
                      <div className={isEjesTematicos ? "flex flex-col gap-2 list-disc pl-5" : "flex flex-col gap-3"}>
                        {area.items.map((item, idx) => (
                          <div key={item}>
                            {isEjesTematicos && idx === 0 ? (
