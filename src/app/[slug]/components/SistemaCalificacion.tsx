...
export default function SistemaCalificacionESSMPage({ course }: { course: Course }) {
  const { loading, error, success: formSubmitted, submitForm, setSuccess: setFormSubmitted } = useContactSubmit(`Formulario de Curso: ${course.title || "Sistema Calificación ESS-M"}`);
    ...
    <main className="min-h-screen bg-white text-[#525252] selection:bg-[#FFC107] selection:text-[#411A56]">
      ...
      <section className="relative min-h-[80vh] flex items-start md:items-center justify-center overflow-hidden pt-32 pb-24 bg-[#700FA3]">
        ...
        <img
          ...
          alt={heroTitle || "Sistema de Calificación ESS-M - One True Academia"}
          fetchPriority="high"
          ...
          <div className="flex flex-col gap-16">
            <div className="flex flex-col gap-12 items-start">
              <div className="w-full max-w-4xl flex flex-col text-left">
                ...
                >
                  {aboutDesc || "Obtenga una guía paso a paso sobre los criterios de administración, evaluación y diagnóstico las técnicas poligráficas validadas en el metaanálisis APA 2011:"}
                </p>
              </div>
            </div>
