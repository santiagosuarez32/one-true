...
export default function ControlDeCalidadEnPoligrafiaPage({ course }: { course: Course }) {
  const { loading, error, success: formSubmitted, submitForm, setSuccess: setFormSubmitted } = useContactSubmit(`Formulario de Curso: ${course.title || "Control de Calidad"}`);
