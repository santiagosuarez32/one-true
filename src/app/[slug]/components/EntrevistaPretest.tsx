...
export default function EntrevistaPretestPage({ course }: { course: Course }) {
  const { loading, error, success: formSubmitted, submitForm, setSuccess: setFormSubmitted } = useContactSubmit(`Formulario de Curso: ${course.title || "Entrevista Pretest"}`);
                      ...
                      <div className="flex flex-col items-center gap-1.5 mt-5 pt-4 border-t border-neutral-100 w-full">
                        ...
                        <div className="elementor-button-wrapper flex justify-center w-auto mt-1">
                          <a 
                            ...
                            href={contactWhatsapp || "https://api.whatsapp.com/send?phone=593099371290&text=%C2%A1Hola!%20Quiero%20conocer%20m%C3%A1s%20sobre%20los%20servicios%20de%20One%20True"}
                            target="_blank"
                            rel="noopener noreferrer"
                            style={{ 
                              fontFamily: "var(--font-montserrat), sans-serif", 
