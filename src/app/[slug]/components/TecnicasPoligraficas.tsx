...
export default function TecnicasPoligraficasPage({ course }: { course: Course }) {
  const { loading, error, success: formSubmitted, submitForm, setSuccess: setFormSubmitted } = useContactSubmit(`Formulario de Curso: ${course.title || "Técnicas Poligráficas"}`);
    ...
    <main className="min-h-screen bg-white text-[#525252] selection:bg-[#FFC107] selection:text-[#411A56]">
      ...
      <section className="relative min-h-[80vh] flex items-start md:items-center justify-center overflow-hidden pt-32 pb-24 bg-[#700FA3]">
        ...
        <img
          ...
          alt={heroTitle || "Técnicas Poligráficas - One True Academia"}
          fetchPriority="high"
