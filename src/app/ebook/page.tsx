...
export default function EbookPage() {
  ...
  return (
    <main className="min-h-screen bg-[#700FA3] text-white selection:bg-[#FFC107] selection:text-[#411A56]">
      <Navbar />
      ...
      <section id="download" className="bg-[#700FA3] pt-32 pb-16 md:py-24 relative overflow-hidden scroll-mt-20">
        ...
        <div className="w-full max-w-6xl lg:max-w-7xl xl:max-w-[1350px] mx-auto px-4 sm:px-8 md:px-12 lg:px-16 flex flex-col lg:flex-row items-center gap-16 lg:gap-24 relative z-10">
          ...
          <div className="w-full lg:w-1/2 flex justify-center lg:justify-end">
            <div ref={cardRef} className="bg-white rounded-2xl p-8 sm:p-10 shadow-[0_20px_50px_rgba(72,37,90,0.08)] border border-neutral-100 w-full max-w-[720px]">

              {/* Ebook Mockup Image Container */}
              <div className="w-full h-[200px] bg-neutral-100 rounded mb-6 relative overflow-hidden flex items-center justify-center">
                ...
                <form className="flex flex-col gap-5" onSubmit={handleSubmit}>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-6 gap-y-5">
                    ...
                    <div className="flex flex-col gap-1.5 text-left">
                      <label className="text-xs sm:text-[13px] font-bold text-neutral-500 uppercase tracking-wider font-montserrat" style={{ fontFamily: "var(--font-montserrat), sans-serif" }}>
                        Correo Electrónico
                      </label>
                      <input
                        type="email"
