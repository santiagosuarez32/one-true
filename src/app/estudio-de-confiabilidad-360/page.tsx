  ...
  return (
    <main className="min-h-screen bg-white text-[#525252] selection:bg-[#FFC107] selection:text-[#411A56]">
      ...
      <section className="bg-white py-20">
        <div className="w-full max-w-6xl lg:max-w-7xl xl:max-w-[1550px] mx-auto px-4 md:px-8 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              {
                title: "Validación de su Trayectoria laboral",
                text: "Verificación directa de sus tres últimas referencias laborales, verificamos cómo fue su desempeño laboral con sus superiores, constatamos los motivos reales de salida."
              },
              {
                title: "Vetting en +190 Bases de Datos",
                text: "Rastreo profundo de antecedentes legales, judiciales y listas de control internacional."
              },
              {
                title: "Análisis de Salud Financiera",
                text: "Evaluamos niveles de endeudamiento y comportamiento crediticio para detectar posibles factores de riesgo o vulnerabilidad."
              },
              {
                title: "Verificación Académica",
                text: "Verificación de la autenticidad de sus títulos académicos registrados y reportados."
              }
            ].map((item, idx) => (
              <div 
                key={idx} 
        ...
        <div className="w-full max-w-6xl lg:max-w-7xl xl:max-w-[1350px] mx-auto px-8 md:px-12 lg:px-16 flex flex-col lg:flex-row items-center gap-8 lg:gap-12 relative z-10">
          ...
          <div className="w-full lg:w-1/2 flex flex-col items-start lg:pl-10">
            ...
            <ul className="flex flex-col gap-3 w-full mb-6">
              {[
                { title: "Prevención de Riesgos", text: "Identifique candidatos con presiones financieras que puedan comprometer la integridad del cargo." },
                { title: "Cero Falsificaciones", text: "Detecte inconsistencias o títulos inexistentes de forma inmediata." },
                { title: "Seguridad en la Toma de Decisión", text: "Reportes técnicos que avalan la idoneidad moral y profesional del postulante." }
              ].map((item, idx) => (
            ...
            >
              <span>Cotizar mi estudio 360</span>
            </a>
