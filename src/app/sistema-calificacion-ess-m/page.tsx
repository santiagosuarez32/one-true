...
export default function SistemaCalificacionESSMPage() {
    ...
    <main className="min-h-screen bg-white text-[#525252] selection:bg-[#FFC107] selection:text-[#411A56]">
      ...
      <section className="relative min-h-[80vh] flex items-start md:items-center justify-center overflow-hidden pt-32 pb-24 bg-[#700FA3]">
        ...
        <img
          ...
          alt="Sistema de Calificación ESS-M - One True Academia"
          fetchPriority="high"
        ...
        <div className="w-full max-w-6xl lg:max-w-7xl xl:max-w-[1350px] mx-auto px-4 sm:px-8 md:px-12 lg:px-16 z-10 flex justify-start items-center">
          <div className="max-w-5xl text-left">
            ...
            <div className="flex items-center gap-3 mb-6">
              ...
              >
                La evolución científica del análisis de datos poligráficos.
              </span>
            </div>
            ...
            >
              Especialización Avanzada: Sistema de Calificación ESS-M
            </h1>
            ...
            >
              El sistema <strong style={{ fontWeight: "800", textDecoration: "underline", textDecorationColor: "#FFC107" }}>ESS-M</strong> representa la vanguardia en la detección psicofisiológica del engaño. Este curso está diseñado para profesionales que exigen un protocolo estandarizado, reproducible y basado en un modelo de referencia multinomial, permitiendo una transición objetiva del dato fisiológico a una conclusión estadística irrefutable.
            </p>
              ...
              <tbody className="divide-y divide-[#700FA3]/20">
                ...
                <tr className="bg-[#700FA3]/5">
                  ...
                  <td className="py-4 px-3 sm:py-5 sm:px-6 text-[#525252] font-light border-l border-[#700FA3]/20 text-sm sm:text-base break-words align-top" style={{ fontFamily: "var(--font-montserrat), sans-serif" }}>
                    <p className="mb-3 text-sm leading-relaxed">Formación técnica de élite para el examinador moderno:</p>
                    <ul className="list-disc pl-5 flex flex-col gap-2">
                      <li>15 horas de formación técnica profunda.</li>
                      <li>32 lecciones con enfoque en rigor científico.</li>
                      <li>Tablas de referencia y hojas de trabajo para análisis manual y automatizado.</li>
                      <li>Guía de referencia rápida del ESS-M para consulta en campo.</li>
                      <li>Acceso por 3 meses a contenido pregrabado de alta definición.</li>
                      <li>Garantía de satisfacción de 30 días.</li>
                      <li>Comunidad ONE TRUE: Soporte continuo en casos complejos.</li>
                      <li>Diploma de finalización: Respaldo de su competencia en el sistema de calificación más actual.</li>
                    </ul>
                  </td>
                </tr>
              </tbody>
