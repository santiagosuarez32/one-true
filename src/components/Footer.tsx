          ...
          <div className="w-full md:w-[28%] flex flex-col items-start text-left">
            ...
            <div className="flex flex-col items-start gap-2 w-full">
              ...
              <div className="flex items-center gap-6 mt-1">
                {/* LinkedIn */}
                <a href="https://www.linkedin.com/in/david-coli-fiallo-75679a198?utm_source=share_via&utm_content=profile&utm_medium=member_android" target="_blank" rel="noopener noreferrer" aria-label="Síguenos en LinkedIn" className="text-[#700FA3] hover:text-[#5C0B87] transition-colors duration-200">
                  <FaLinkedin className="w-5 h-5" />
                </a>
                {/* Facebook */}
                <a href="https://www.facebook.com/share/1F8T24NNKE/" target="_blank" rel="noopener noreferrer" aria-label="Síguenos en Facebook" className="text-[#700FA3] hover:text-[#5C0B87] transition-colors duration-200">
                  <FaFacebook className="w-5 h-5" />
                </a>
                {/* Instagram */}
                <a href="https://www.instagram.com/somosonetrue?igsh=bXNmOWYwaWpsdDVh" target="_blank" rel="noopener noreferrer" aria-label="Síguenos en Instagram" className="text-[#700FA3] hover:text-[#5C0B87] transition-colors duration-200">
                  <FaInstagram className="w-5 h-5" />
                </a>
                {/* YouTube */}
                <a href="https://youtube.com/@somosonetrue?si=8OI3ZQ0A-4OzF_H0" target="_blank" rel="noopener noreferrer" aria-label="Síguenos en YouTube" className="text-[#700FA3] hover:text-[#5C0B87] transition-colors duration-200">
