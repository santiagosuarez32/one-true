        ...
        <div className="flex flex-col md:flex-row justify-between items-start gap-12 lg:gap-24 mb-16">
          ...
          <div className="w-full md:w-5/12 flex flex-col items-start text-left">
            ...
            <div className="flex items-center mb-6">
              <img src="/footer.png" alt="One True Logo" className="h-24 md:h-32 w-auto object-contain" />
            </div>
          ...
          <div className="w-full md:w-4/12 flex flex-col items-start text-left">
            ...
            <ul className="flex flex-col gap-4 mb-8">
              <li className="flex items-center gap-3 !text-neutral-300 text-sm md:text-base font-light">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"></path><polyline points="22,6 12,13 2,6"></polyline></svg>
                contacto@onetrue.com
              </li>
              <li className="flex items-center gap-3 !text-neutral-300 text-sm md:text-base font-light">
            ...
            <div className="flex items-center gap-3">
              {/* Instagram */}
              <a href="#" className="w-10 h-10 bg-[#700FA3]/50 rounded hover:bg-[#700FA3] transition-colors duration-300 flex items-center justify-center !text-white">
