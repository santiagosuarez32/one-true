...
export default function FloatingWhatsApp({
  ...
  const node = (
    <a
      ...
      style={fabStyle}
    >
      <span className="wa-ring pointer-events-none" aria-hidden="true" />
      <span className="wa-ring2 pointer-events-none" aria-hidden="true" />
      <svg 
      ...
      <span className="wa-sr pointer-events-none">Escribir por WhatsApp</span>
    </a>
  );
