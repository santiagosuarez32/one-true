...
export default function ContactoFormAvanzados({
  ...
  useEffect(() => {
    const handleClickOutside = (event: MouseEvent) => {
      // Logic for closing dropdowns outside the component if any remain
    };
  ...
  return (
    ...
    >
      ...
      <div className="w-full max-w-6xl lg:max-w-7xl xl:max-w-[1200px] mx-auto px-6 md:px-12 relative z-10">
                    ...
                    <div className="elementor-button-wrapper flex justify-center w-auto mt-1">
                      ...
                      >
                        <span className="elementor-button-content-wrapper flex items-center justify-center gap-2" style={{ color: "#ffffff" }}>
                          ...
                          <span className="elementor-button-text font-bold" style={{ color: "#ffffff", fontWeight: "bold" }}>{contactWhatsappText}</span>
                        </span>
                      </a>
                    </div>
                  </div>
